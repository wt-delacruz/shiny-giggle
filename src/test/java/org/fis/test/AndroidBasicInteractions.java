...
public class AndroidBasicInteractions extends BaseTest {
    ...
    public static void startAppiumServer() {
        ...
        serviceBuilder.withAppiumJS(new File("/Users/wdelacruz/.nvm/versions/node/v12.14.0/bin/org.fis.test.util.appium"));
